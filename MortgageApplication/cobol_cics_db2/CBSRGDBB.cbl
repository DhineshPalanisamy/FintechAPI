      ...
      *     INTO
      *     :H1-ACCOUT-NUMBER, :H1-ACCOUNT-STATUS, :H1-UPD-USERID,
      *     :H1-CUSTOMER-ID
           ...
           EVALUATE SQLCODE
            WHEN 0
             ...
             DISPLAY 'MESSAGES:'
            WHEN 100
             MOVE "ACCOUNT DOES NOT EXIT WIT BANK" TO MESSAGES
        ...
        CHECK-ACCT-STATUS.
           ...
           EVALUATE WS-ACCOUNT-STATUS
              WHEN 'ACTIVE    '
               ...
               MOVE 'CUSTOMER IS ALREADY REGISTERED' TO MESSAGES
               EXEC CICS RETURN END-EXEC
              WHEN 'INACTIVE  '
        ...
        REG-ACCT-STATS.
           ...
           END-EXEC.
           DISPLAY SQLCODE
            MOVE "CUSTOMER REGISTERED SUCESSULLY" TO MESSAGES.
        REG-ACCT-STATS-EXIT.
            EXIT.